		...
		if(isset($this->request->query['price_select'])){
			...
			if($ubicacion != '0'){
				...
				if($ubicacion == 'us'){
					...
					$conditions["Propierty.ubicacion"] = $us;
				}elseif($ubicacion == 'mx'){
					$mx = array("Aguascalientes","Baja California","Baja California Sur","Campeche","Chiapas","Chihuahua","Coahuila","Colima","Distrito Federal","Durango","Estado de Mexico","Guanajuato","Guerrero","Hidalgo","Jalisco","Michoacan","Morelos","Nayarit","Nuevo Lean","Oaxaca","Puebla","Queretaro","Quintana Roo","San Luis Potosí","Sinaloa","Sonora","Tabasco","Tamaulipas","Tlaxcala","Veracruz","Yucatan","Zacatecas");
					$conditions["Propierty.ubicacion"] = $mx;
				}else{
