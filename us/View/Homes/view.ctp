...
<?php echo $this->Form->create('Home'); ?>
    <fieldset>
      ...
      <div class="margenesHorizontales">
	        ...
	        <div class="form-group">
	          <label>Url</label>
	          <?php echo $this->Form->input('url',array('div'=>false, 'required'=>true,'label'=>false,'class'=>'form-control','placeholder'=>'URL', 'required'=>true)); ?>
	        </div>
				</div>
