...
<?php echo $this->Form->create('Propierty'); ?>
    <fieldset>
      <legend>Agregar Propiedad</legend>
      <div class="margenesHorizontales">
	        ...
	        <div class="form-group">
	          ...
	          <?php echo $this->Form->input('valor',array('div'=>false, 'required'=>true,'label'=>false,'class'=>array('form-control','money'),'placeholder'=>'Valor de la propiedad ($)', 'required'=>true,'type'=>'text')); ?>
	        </div>
				</div>
	        ...
	        <div class="form-group">
	          ...
	          <?php echo $this->Form->input('status_top',array('div'=>false, 'required'=>true,'label'=>false,'class'=>array('form-control','money'),'placeholder'=>'Capital a levantar ($)','type'=>'text')); ?>
	        </div>
	      </div>
	        ...
	        <div class="form-group">
	          ...
	          <?php echo $this->Form->input('recaudado',array('div'=>false, 'required'=>true,'label'=>false,'class'=>array('form-control','money'),'placeholder'=>'Total Recaudado ($)','type'=>'text')); ?>
	        </div>
	      </div>
